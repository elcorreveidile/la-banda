...
${COMUN}
Si kind = "muestra": lee leerPcic("gramatica") y leerPcic("nociones-especificas") para el nivel. Añade "perfil": { "nivel", "palabrasObjetivo": { "min", "max" }, "gramaticaPermitida": 4-8 recursos del PCIC del nivel, "gramaticaProhibida": 2-4 recursos de niveles superiores que NO deben aparecer, "lexicoObjetivo": 8-15 palabras o expresiones, "registro" }. Si tipo = "texto_escrito", el "registro" es el propio del género escrito (formal o semiformal según toque) y añade "cohesionObjetivo": 3-6 conectores o mecanismos de cohesión esperables al nivel.
...
${COMUN}
Si kind = "muestra": aplica la RÚBRICA DE CREDIBILIDAD y vetas si (a) hay datos de Granada sin documentar, (b) la gramática o el léxico exceden el nivel, (c) la procedencia no está declarada o una pieza "adaptada" no cita fuente, (d) algún código no está en el etiquetario (compruébalo con leerEtiquetario), (e) el texto es artificial o suena a manual, (f) en muestra de habla, el TRATO no encaja con el escenario (usted en un bar o taberna, o tú donde tocaría usted), (g) hay incoherencias internas o de la lógica local (la tapa gratis que luego se cobra, datos que se contradicen entre sí), (h) es muestra de habla y NO tiene color oral de Granada (suena neutro, de laboratorio), (i) en muestra de habla, los saludos o la hora no cuadran (p. ej. «buenas tardes» a mediodía, o dos saludos distintos seguidos), (j) hay muy pocas anotaciones para el nivel (densidad claramente insuficiente), (k) en texto escrito, el género o el registro no corresponden, falta cohesión, o un texto formal inventa citas, cifras o fuentes. Añade "veredictoPalermo": { "veta": true|false, "motivos": lista, "razon": una frase }.
